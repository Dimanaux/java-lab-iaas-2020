package ru.itis.java_lab.security;
...
import ru.itis.java_lab.security.details.UserDetailsImpl;
import ru.itis.java_lab.security.filters.JwtAuthenticationFilter;
import ru.itis.java_lab.security.providers.JwtAuthenticationProvider;
import ru.itis.java_lab.security.util.JwtTokenUtil;

@Configuration
@EnableGlobalMethodSecurity(prePostEnabled = true)
@EnableWebSecurity
@ComponentScan("ru.itis.java_lab")
